...
zippedinput_path = main_path + '/framework/pre-processing/interleaved-dataframe/_output-zipped/'
output_path = main_path + '/framework/pre-processing/image-builder/_output/'
